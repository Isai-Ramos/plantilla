...
$routes->get('/inicio', 'Crud::inicio');
$routes->get('/inicioadmin', 'Crud::inicioadmin');
$routes->get('/login', 'Crud::login');

$routes->get('/listado', 'Crud::listado');
...
$routes->post('/log', 'Crud::log');
$routes->get('/salir', 'Crud::salir');
/**
 * --------------------------------------------------------------------
 * Additional Routing
 * --------------------------------------------------------------------
